class PoolGame {
    ...
    loadSounds() {
        return new Promise((resolve) => {
            ...
            const soundPaths = [
                { key: 'cueHit', paths: ['assets/sounds/cue-hit.mp3', 'assets/sounds/cue-hit.wav', 'assets/sounds/cuehitting.mp3', 'assets/sounds/cuehitting.wav', 'assets/sounds/cue-hitting-ball.mp3', 'assets/sounds/cue-hitting-ball.wav', 'assets/sounds/normal-cue-hit.mp3', 'assets/sounds/normal-cue-hit.wav', 'assets/sounds/cue.mp3', 'assets/sounds/cue.wav'] },
                { key: 'ballHit', paths: ['assets/sounds/ball-hit.mp3', 'assets/sounds/ball-hit.wav', 'assets/sounds/ballhitting.mp3', 'assets/sounds/ballhitting.wav', 'assets/sounds/ball-hitting-ball.mp3', 'assets/sounds/ball-hitting-ball.wav', 'assets/sounds/normal-ball-hit.mp3', 'assets/sounds/normal-ball-hit.wav', 'assets/sounds/collision.mp3', 'assets/sounds/collision.wav'] },
                { key: 'breakCueHit', paths: ['assets/sounds/break-cue-hit.mp3', 'assets/sounds/break-cue-hit.wav', 'assets/sounds/breakcuehit.mp3', 'assets/sounds/breakcuehit.wav', 'assets/sounds/break-cue-hitting-ball.mp3', 'assets/sounds/break-cue-hitting-ball.wav', 'assets/sounds/breaking-cue.mp3', 'assets/sounds/breaking-cue.wav', 'assets/sounds/break.mp3', 'assets/sounds/break.wav'] },
                { key: 'breakBallHit', paths: ['assets/sounds/break-ball-hit.mp3', 'assets/sounds/break-ball-hit.wav', 'assets/sounds/breakballhit.mp3', 'assets/sounds/breakballhit.wav', 'assets/sounds/break-ball-hitting-ball.mp3', 'assets/sounds/break-ball-hitting-ball.wav', 'assets/sounds/breaking-ball-hit.mp3', 'assets/sounds/breaking-ball-hit.wav'] },
                { key: 'potting', paths: ['assets/sounds/potting.mp3', 'assets/sounds/potting.wav', 'assets/sounds/pot.mp3', 'assets/sounds/pot.wav', 'assets/sounds/pocket.mp3', 'assets/sounds/pocket.wav'] }
            ];
